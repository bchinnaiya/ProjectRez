        ...
        <div className="row align-items-center">
          ...
          <div className="card">
            <div className="funfact-content funfact-res text-left paddingnew">
              ...
              Looking good on the outside makes you feel good one on the inside. Our proven ingredient strengthens nails, restores the thickness and lustre of your hair and nourishes your skin from within for elasticity and glow. So you can feel and look your best.</p>
                {/* <div className="ptag">
